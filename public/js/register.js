...
document.getElementById('registerForm').addEventListener('submit', function(e) {
    ...
    if (validateStep(1) && validateStep(2) && validateStep(3)) {
        ...
        setTimeout(() => {
            hideLoading();
            showNotification('สมัครสมาชิกสำเร็จ! กำลังนำทางไปหน้าเข้าสู่ระบบ...', 'success');
...
document.getElementById('birthDate').addEventListener('change', function() {
    ...
    if (age < 20) {
        showNotification('คำเตือน: คุณต้องมีอายุอย่างน้อย 20 ปีเพื่อสมัครสมาชิก Khon Armory', 'error');
    }
});
